...
<template>
  <footer class="footer_guide">
    ...
    <div class="guide_item" @click="goTo('/home')" :class="{on:$route.path==='/home'}">
      <img src="../../../static/images/icon_首页-选中.png" v-if="$route.path==='/home'">
      <img src="../../../static/images/icon_首页-未选中.png" v-else>
      <span class="guide_name">首页</span>
    </div>
    <div class="guide_item" @click="goTo('/order')" :class="{on:$route.path==='/order'}">
      <img src="../../../static/images/icon_订单-选中.png" v-if="$route.path==='/order'">
      <img src="../../../static/images/icon_订单-未选中.png" v-else>
      <span class="guide_name">订单</span>
    </div>
    <div class="guide_item" @click="goTo('/mine')" :class="{on:$route.path==='/mine'}">
      <img src="../../../static/images/icon_我的-选中.png" v-if="$route.path==='/mine'">
      <img src="../../../static/images/icon_我的-未选中.png" v-else>
