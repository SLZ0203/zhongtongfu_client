  ...
  <section>
    ...
    <div class="scroll_wrap">
      <ul ref="selectUl" class="selectUl">
        <li class="addList" v-for="(v,index) in info" @click="getProvinceId(v.id, v.name, index)"
            v-show="showProvince" :class="v.selected ? 'active' : ''">{{v.name}}
        </li>
        <li class="addList" v-for="(v,index) in showCityList" @click="getCityId(v.id, v.name, index)"
            v-show="showCity" :class="v.selected ? 'active' : ''">{{v.name}}
        </li>
        <li class="addList" v-for="(v,index) in showDistrictList" @click="getDistrictId(v.id, v.name, index)"
